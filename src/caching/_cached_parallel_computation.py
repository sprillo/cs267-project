...
def _check_usefull_stuff_cached_parallel_computation(
    func,
    exclude_args,
    parallel_arg,
    output_dirs,
    ...
    _write_usefull_stuff_cached_parallel_computation are correct.
    ...
    def cached_parallel_computation_decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            for output_dir in output_dirs:
                ...
                _check_usefull_stuff_cached_parallel_computation(
                    func,
                    exclude_args,
                    parallel_arg,
                    output_dirs,
